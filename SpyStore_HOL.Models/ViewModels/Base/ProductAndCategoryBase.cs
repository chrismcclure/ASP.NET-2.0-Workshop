...
namespace SpyStore_HOL.Models.ViewModels.Base
{
    public class ProductAndCategoryBase : EntityBase
    {
        ...
        [MaxLength(50)] [Display(Name = "Model")] public string ModelName { get; set; }
        [Display(Name = "Is Featured Product")] public bool IsFeatured { get; set; }
        [MaxLength(50)] [Display(Name = "Model Number")] public string ModelNumber { get; set; }
        ...
        [DataType(DataType.Currency), Display(Name = "Cost")] public decimal UnitCost { get; set; }
        [DataType(DataType.Currency), Display(Name = "Price")] public decimal CurrentPrice { get; set; }
